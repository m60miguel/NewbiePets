...
class _ForumPageState extends State<ForumPage> {
  ...
  var topCategoyIcons = new Container(
    ...
    child: new Container(
      ...
      child: new Row(
        ...
        children: <Widget>[
          new CategoryIcon(Icons.landscape, "Paseos", true),
          new CategoryIcon(Icons.healing, "Cuidados", false),
          new CategoryIcon(Icons.child_friendly, "Cachorros", false),
          new CategoryIcon(Icons.place, "Lugares", false),
        ],
      ),
    ),
  );
  ...
  var categoryMetric = new Container(
    ...
    child: new Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.center,
      children: <Widget>[
        new CategoryIcon(Icons.restaurant_menu, "Alimentación", false),
        new CategoryIcon(Icons.announcement, "Anuncios", false),
        new CategoryIcon(Icons.videogame_asset, "Juegos", false),
        new CategoryIcon(Icons.all_inclusive, "Otros", false),
      ],
    ),
  );
