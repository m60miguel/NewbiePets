            ...
            new Form(
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    new Text("Datos De Inicio", style: TextStyle(fontSize: 20.0)),
                    new TextFormField(
                      decoration: new InputDecoration(hintText: "E-mail"),
                      keyboardType: TextInputType.emailAddress,
                    ),
                    new TextFormField(
                      decoration: new InputDecoration(hintText: "Repetir E-mail"),
                      keyboardType: TextInputType.emailAddress,
                    ),
                    new TextFormField(
                    ...
                    new TextFormField(
                      decoration: new InputDecoration(hintText: "Repetir Contraseña"),
                      keyboardType: TextInputType.text,
                      obscureText: true,
                    ),
                    new Padding(
                    ...
                    new Text("Datos Personales", style: TextStyle(fontSize: 20.0)),
                    new TextFormField(
